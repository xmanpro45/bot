<?php
    ...
    $gate1 = "xman/api.php"; /// Your Checker URl with api.php or chk.php
  //$gate2 = "";
if($message == "/start"){
...
*/
    function send_message($chat_id,$message_id, $message){
        ...
        $apiToken = "5391895188:AAG44_ejjoLWXB4nboOC23o7at8a-gFR8x4"; ///Bot api token  
